...
describe('four-file styling contract', () => {
    ...
    test('Shiny preserves its chrome, light navigation strip, and glossy graphical tokens', async () => {
        ...
        assert.match(css, /--navigation-link-line-height:\s*1\.7em/)
        ...
        assert.match(css, /--colored-background:[\s\S]*radial-gradient\(140% 75% at 30% 10%, #fff0, #fff1 47%, #fff0 55%, #fff0\)[\s\S]*var\(--colored-base-bg\)/)
