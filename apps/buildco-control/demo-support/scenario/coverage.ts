import type {CivilDate, ScenarioData} from "../../src/domain/model.ts";
import {analyzeScenario, classifyHealth, type ScenarioAnalysis} from "../../src/domain/projections.ts";
import {scenarioAtDate} from "../../src/domain/snapshot.ts";
import {byId, groupBy} from "../../src/domain/collections.ts";
import {dateOf} from "../../src/domain/calendar.ts";
